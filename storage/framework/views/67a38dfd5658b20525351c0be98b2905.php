    ...
    <section class="hero">
        ...
        <?php if($isGuest): ?>
            <p class="hero-desc" style="margin-top: 0.75rem;">
                Mode guest aktif: privasi tetap aman, sisa upload hari ini <?php echo e($guestRemainingUploads); ?>/5, maksimal <?php echo e($maxUploadMb); ?> MB per file.
            </p>
        <?php endif; ?>
    </section>
    ...
    <div class="card-wrap">
        <div class="upload-card">
            <div class="drop-zone" id="dropZone">
                ...
                <div class="drop-subtitle">JPG, PNG, GIF, WebP — Maks. <?php echo e($maxUploadMb); ?> MB</div>
            </div>
...
submitBtn.addEventListener('click', async () => {
    ...
    try {
        ...
        if (res.ok && data.success) {
            ...
            if (res.status === 413) {
                errorText = '❌ File terlalu besar! Maksimal ukuran adalah ' + '<div class="drop-subtitle" id="dropSubtitle">JPG, PNG, GIF, WebP — Maks. <?php echo e($maxUploadMb); ?> MB</div>';
...
<?php /**PATH D:\ImageConverter\imageconvert\resources\views/index.blade.php ENDPATH**/ ?>